...
namespace KS.SceneFusion.Extensions.Editor
{
    ...
    public class Ferr2DExtension
    {
        ...
        static Ferr2DExtension()
        {
            ...
            SceneFusionAPI.BeforeSpawnRequest += BeforeSpawnRequest;
        ...
        /**
         * Called before sending a spawn request for a game object to the server. Adds our adaptor component to Ferr2D
         * objects to sync some additional data.
         * 
        ...
        private static void BeforeSpawnRequest(GameObject gameObject)
        {
            ...
            if (path != null)
            {
                // This is Ferr2D object. Add our adaptor component if there isn't one already.
